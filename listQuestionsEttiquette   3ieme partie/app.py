...
@app.route('/generer_sujets', methods=['POST'])
def generer_sujets():
    # récupérer le nombre de sujets saisi dans le formulaire
    nb_sujets = request.form['GQ']
    
    # générer les sujets
    #sujets = [f"Sujet {i}" for i in range(1, int(nb_sujets) + 1)]
    
    # passer les sujets à la page HTML "sujetsGeneres.html"
